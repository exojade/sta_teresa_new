              ...
              <table class="table table-bordered table-striped sample-datatable">
                ...
                <tbody>
                  <?php foreach($payroll as $p): ?>
                    <?php
                      $payroll_employee = query("
                      select * from payroll_employee where payroll_id = ?", $p["payroll_id"]);
                    ?>
                    <tr>
                      <td>
                        <a href="#" title="Update employee" data-toggle="modal" data-target="#modal_<?php echo($p["payroll_id"]); ?>" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                        <a href="#" title="Delete employee" data-toggle="modal" data-target="#modal_<?php echo($p["payroll_id"]); ?>" class="btn btn-danger"><i class="fa fa-close"></i></a>
					            </td>
