  ...
  <div class="content-wrapper">
    ...
    <div class="box">
            <div class="box-header">
              <h3 class="box-title">Burial Service Contract</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table table-bordered table-striped sample-datatable">
                ...
                <tbody>
                  <?php foreach($contracts as $contract): ?>
                    ...
                    <?php
                    $total_payment = 0;
                    if(isset($Transactions[$contract["contract_id"]])){
                      foreach($Transactions[$contract["contract_id"]] as $transaction): 
                    ...
                    <tr>
                      ...
                      <td><?php echo($contract["deceased_gender"]); ?></td>
