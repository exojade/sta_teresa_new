          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><?php echo($chapel["chapel"]); ?></h4>
              </div>
              <form class="general_form" data-url="chapels">
              <div class="modal-body">
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">chapel Name</label>
                  <input required type="text" value="<?php echo($chapel["chapel"]); ?>" name="chapel" class="form-control" id="exampleInputEmail1" placeholder="---">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Price / Amount</label>
                  <input required type="number" value="<?php echo($chapel["amount"]); ?>" name="amount" class="form-control" id="exampleInputEmail1" placeholder="---">
                </div>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><?php echo($chapel["chapel"]); ?> | Add image</h4>
              </div>
              <form class="general_form" data-url="chapels">
              <div class="modal-body">
                ...
                <tbody>
                  <?php foreach($chapels as $chapel): ?>
                    <tr>
                      ...
                      <td><?php echo($chapel["chapel"]); ?></td>
                      <td><?php echo($chapel["amount"]); ?></td>
                      <td>
                      <?php if(isset($chapels_image[$chapel["chapel_id"]])): ?>
                        <?php foreach($chapels_image[$chapel["chapel_id"]] as $image): ?>
                          <a data-toggle="modal" data-target="#modal_<?php echo($image["chapel_image_id"]); ?>"  href="#" ><img style="border: 2px solid black;" src="<?php echo($image["image_url"]); ?>" width="50" height="50"></a>
                        <?php endforeach; ?>
